...
public class UserUpdateProfileService {
    ...
    public ApiResponse<GeneralDataResponse> updateProfile(UserProfileDto dto, HttpServletRequest request) {
        ...
        if (i!=0){
            return new ApiResponse<>(200,"修改成功",new GeneralDataResponse(true,null));
        }
        return new ApiResponse<>(400,"修改失败",new GeneralDataResponse(true,null));
    }
}
