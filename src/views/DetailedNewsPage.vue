  ...
  <main class="container mx-auto px-4 pt-28 pb-16">
    ...
    <section class="mb-12">
      ...
      <div class="bg-gray-900 rounded-xl shadow-lg p-6 md:p-8">
        <div class="prose prose-invert max-w-none text-gray-300 leading-relaxed text-center">
        ...
        <div class="mt-8 flex items-center gap-8 border-t-2 border-gray-400 pt-6">
          <button
            ...
            :class="[isLiked?'text-white':'text-gray-300','flex items-center gap-2 hover:text-white transition-colors']"
          >
          ...
          <button
            ...
            :class="[isDisliked?'text-white':'text-gray-300','flex items-center gap-2 hover:text-white transition-colors']"
          >
    ...
    <section class="mb-12">
      <div class="bg-gray-900 rounded-xl shadow-lg p-6 md:p-8">
        ...
        <div class="space-y-6">
          ...
          <!-- 评论项 -->
          <div v-for="(comment, idx) in comments" :key="idx" class="bg-gray-800 rounded-xl p-4 md:p-6 shadow-md">
            <!-- 评论头部 - 用户名+时间 -->
            ...
            <div class="flex items-center gap-6">
              <button
                ...
                :class="[comment.liked ? 'text-blue-500' : 'text-gray-500', 'flex items-center gap-1 hover:text-gray-300 transition-colors']"
              >
...
const { news, newsId } = defineProps({
  ...
  news: {
    ...
    default: () => ({
      cover: '/img/gta6.jpg',
      category: '游戏资讯',
      title: 'GTA6最新爆料：预计2025年正式上线',
      time: '30分钟前',
      source: '环球新闻记者报道 ',
      content: [
        'Rockstar Games近日通过官方渠道透露，备受期待的《GTA6》目前已进入最终研发阶段，预计将在2025年第四季度正式上线。',
        '据内部人士消息，本次GTA6将采用全新的游戏引擎，画面表现力将达到行业顶尖水平，同时开放世界的规模也将是前作的2倍以上。',
        '此外，游戏还将首次加入跨平台联机功能，支持PS5、Xbox Series X/S和PC端的玩家互通游玩。'
      ],
      likeCount: 652,
      commentCount: 89,
    }),
